        ...
        for e in p.event.get():
            if e.type == p.QUIT:
                ...
                sqSelected, playerClicks, moveMade, animate = handle_mouse_click(sqSelected, playerClicks, gs,
                                                                                 validMoves, moveMade, animate, isHumanTurn)
            elif e.type == p.KEYDOWN:
                gs, validMoves, sqSelected, playerClicks, moveMade, animate, gameOver, AIThinking, moveUndone = handle_key_press(e, gs, validMoves, sqSelected, playerClicks, gameOver, AIThinking, moveFinderProcess, moveUndone)
